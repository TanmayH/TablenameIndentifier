...
public class POSTaggerExample {
	...
	{	
     ...
     public static void hypernymchecker(ArrayList<String> nounlist)
	 {
	 	WordNet hyp=new WordNet("resources//synsets.txt","resources//hypernyms.txt");
	 	String ancestor;
	 	for (int i=0;i<nounlist.size();i++)
		{
			ancestor=hyp.findhypernym(nounlist.get(i));
			if (!ancestor.equals("Not found"))
			{
				tablenameslist.add(ancestor);
				nounlist.remove(i);
				System.out.println("table found");
				break;
			}
